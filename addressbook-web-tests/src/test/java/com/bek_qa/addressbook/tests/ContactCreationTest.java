...
public class ContactCreationTest extends TestBase {
    ...
    public void testContactCreation() {
        ...
        applicationManager.getContactHelper().fillContactForm(new ContactData("Ivan", "Ivanov", "test4", "Columbia Home Health Care ", "3354 E.Broad St", "3354 E.Broad St\nSTE H", "3354 E.Broad St\nSTE H\nColumbus, OH 43230", "614-308-0100", "info@columbiahhc.com"), true);
