...
public class ContactModificationTest extends TestBase {
    ...
    public void testContactModofocation(){
        ...
        applicationManager.getContactHelper().fillContactForm(new ContactData("Stepan", "Ivanov", null, "Columbia Home Health Care ", "3354 E.Broad St", "3354 E.Broad St\nSTE H", "3354 E.Broad St\nSTE H\nColumbus, OH 43230", "614-308-0100", "info@columbiahhc.com"), false);
